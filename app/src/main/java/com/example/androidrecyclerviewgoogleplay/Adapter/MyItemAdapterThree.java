...
public class MyItemAdapterThree extends RecyclerView.Adapter<MyItemAdapterThree.MyViewHolder> {

    private Context context;
    private List<ItemData> itemDataList;

    public MyItemAdapterThree(Context context, List<ItemData> itemDataList) {
        ...
        holder.setiItemClickListener(new IItemClickListener() {
            ...
            public void onItemClickListener(View view, int position) {
                ...
                if(holder.getAdapterPosition()==0){
                    ...
                    Intent intent = new Intent(view.getContext(), DrinkDrink3Activity.class);
                    context.startActivity(intent);
                }
                else if (holder.getAdapterPosition() == 3){
                    Intent intent = new Intent(view.getContext(), DrinkDrink4Activity.class);
                    context.startActivity(intent);
                }
                else if (holder.getAdapterPosition() == 4){
                    Intent intent = new Intent(view.getContext(), DrinkDrink5Activity.class);
                    context.startActivity(intent);
                }
                else {
